    ...
    dropdown: (
      <HeaderDropdownContent
            ...
            items: [
              {
                ...
                href: "https://github.com/unclecode/crawl4ai#features",
                iconClassName: "-mt-1",
              },
              {
                icon: (
              ...
              },
              {
                ...
                label: "MCP",
                description: "Connect Crawl4AI to agents",
            ...
            items: [
              {
                ...
                href: "https://github.com/unclecode/crawl4ai#use-cases/ai-platforms",
                target: "_blank",
              },
              {
                icon: <Lead />,
                ...
                href: "https://github.com/unclecode/crawl4ai#use-cases/lead-enrichment",
                target: "_blank",
              },
              {
                icon: <Platforms />,
                ...
                href: "https://github.com/unclecode/crawl4ai#use-cases/seo-platforms",
                target: "_blank",
              },
              {
                icon: <Research />,
                ...
                href: "https://github.com/unclecode/crawl4ai#use-cases/deep-research",
                target: "_blank",
              },
              {
                icon: <ArrowRight />,
                ...
                href: "https://github.com/unclecode/crawl4ai#use-cases/overview",
                target: "_blank",
              },
            ],
          },
        ...
        sideItem={{
          ...
          description: "Browse Crawl4AI success stories",
        ...
        navigationItems={[
          {
            ...
            items: [
              ...
              // { icon: <ArrowRight/>, label: 'Docs', description: 'Read the docs.', href: 'https://github.com/unclecode/crawl4ai/features/extract', target: '_blank' },
            ],
          },
        ]}
        sideContent={
        ...
        navigationItems={[
          {
            ...
            items: [
              // { icon: <Templates />, label: 'Templates', description: 'Jumpstart your web scraping', href: '/templates' },
              {
                icon: <Changelog />,
                label: "Changelog",
                description: "Latest APl updates for Crawl4AI",
                href: "/changelog",
              },
              {
                icon: <Api />,
